...
angle_dif = 30  # Angle range on each side (total 60 deg)
distance_max = 3  # Max distance to consider

angle_min = 180 - angle_dif
angle_max = 180 + angle_dif

scan_buffer = []  # Buffer for scan averaging
...
scan = ydlidar.LaserScan()  # Laser scan object
...
def process_averaged_scan():
    ...
    # Detect corners (function must be defined elsewhere)
...
# Corner detection function is commented out below for reference
